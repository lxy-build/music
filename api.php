...
if(!defined('DEBUG') || DEBUG !== true) 
	error_reporting(0); // 屏蔽服务器错误

require_once('php/load.php');/*加载文件一次*/

use Metowolf\Meting; /*使用Meting类*/

$source = getParam('source', 'netease');  // 歌曲源
$API = new Meting($source); /*new 一个Meting类实例*/
...
function getParam($key, $default='')
{
	...
	/*isset是判断一个变量是否定义过,即使它没有值,返回值也是true*/
